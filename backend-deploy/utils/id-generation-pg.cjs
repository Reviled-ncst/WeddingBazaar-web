/**
 * Updated ID generation functions for production backend (PostgreSQL Pool version)
...
async function getNextUserId(db, role) {
  try {
...
// Helper function to get the next sequential ID for services (PostgreSQL Pool version)
async function getNextServiceId(db) {
  try {
