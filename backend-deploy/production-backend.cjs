...
app.post('/api/bookings/request', async (req, res) => {
  try {
    ...
    // FIXED: Add fields gradually to avoid column name issues
    await sql`
      INSERT INTO bookings (
        id, couple_id, vendor_id, service_name, event_date, event_time,
        event_location, guest_count, budget_range, special_requests, 
        ...
        ${properBookingData.event_location}, ${properBookingData.guest_count}, ${properBookingData.budget_range}, 
        ${properBookingData.special_requests}, ${properBookingData.status}, ${now}, ${now}
      )
    `;
