...
app.get('/api/reviews/service/:serviceId', async (req, res) => {
    ...
    try {
        ...
        console.log(`✅ [REVIEWS] Found ${reviews.rows.length} reviews for service ${serviceId}`);
...
// GET /api/reviews/vendor/:vendorId - Get reviews for a specific vendor
app.get('/api/reviews/vendor/:vendorId', async (req, res) => {
    ...
    try {
        ...
        console.log(`✅ [REVIEWS] Found ${reviews.rows.length} reviews for vendor ${vendorId}`);
