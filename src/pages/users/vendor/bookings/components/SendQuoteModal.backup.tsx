...
// Comprehensive service templates with detailed itemization and packages
const QUOTE_TEMPLATES: Record<string, QuoteTemplate> = {
  ...
  'Wedding Planning': {
    ...
    items: [
  ...
  }
      {
        ...
        description: 'Lapel and handheld microphones for ceremony, speeches, and toasts',
        quantity: 4,
        unitPrice: 2500,
        category: 'Equipment'
      },
      {
        ...
        description: 'Pre-event consultation for song selection and special requests',
        quantity: 1,
        unitPrice: 5000,
        category: 'Consultation'
      },
      {
        name: 'Setup and Breakdown',
        description: 'Professional setup before event and complete breakdown after',
        quantity: 1,
        unitPrice: 8000,
        category: 'Services'
      }
    ...
    items: [
      {
        ...
        description: '3-course plated dinner service with choice of entrees',
        quantity: 100,
        unitPrice: 850,
      ...
      },
      {
        ...
        description: 'Assorted hors d\'oeuvres and canapés during cocktail reception',
        quantity: 100,
        unitPrice: 350,
        category: 'Food & Beverage'
      },
      {
        name: 'Wedding Cake',
        description: 'Custom 3-tier wedding cake with professional decoration',
        quantity: 1,
        unitPrice: 15000,
        category: 'Desserts'
      },
      {
        name: 'Bar Service (Open Bar)',
        description: 'Full premium bar service with bartender for 6 hours',
        quantity: 1,
        unitPrice: 35000,
        category: 'Beverage Service'
      },
      {
        name: 'Service Staff',
        description: 'Professional waitstaff, coordinators, and cleanup crew',
        quantity: 8,
        unitPrice: 3500,
        category: 'Service'
      },
      {
        ...
        description: 'Premium table linens, centerpieces, and complete place settings',
        quantity: 12,
        unitPrice: 1200,
  ...
  'Wedding Planning': {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Sourcing, vetting, and managing all wedding vendors',
        quantity: 1,
        unitPrice: 25000,
        category: 'Vendor Management'
      },
      {
        ...
        description: 'Detailed wedding day timeline and coordination schedule',
        quantity: 1,
        unitPrice: 8000,
      ...
      },
      {
        ...
        description: 'Wedding budget creation, tracking, and cost optimization',
        quantity: 1,
        unitPrice: 12000,
      ...
      {
        name: 'Day-of Coordination',
        description: 'Full-day wedding coordination and vendor management',
        quantity: 1,
        unitPrice: 30000,
        category: 'Event Management'
      },
      {
        name: 'Emergency Kit & Backup Plans',
        description: 'Wedding day emergency supplies and contingency planning',
        quantity: 1,
        unitPrice: 5000,
    ...
    items: [
      {
        ...
        description: 'Professional bridal hair styling with trial session',
        quantity: 1,
        unitPrice: 12000,
      ...
      },
      {
        ...
        description: 'Professional bridal makeup with trial session and touch-ups',
        quantity: 1,
        unitPrice: 15000,
        category: 'Bridal Services'
      },
      {
        ...
        description: 'Hair styling for bridesmaids (up to 4 bridesmaids)',
        quantity: 4,
        unitPrice: 4500,
      ...
      },
      {
        ...
        description: 'Makeup application for bridesmaids',
        quantity: 4,
        unitPrice: 3500,
        category: 'Bridesmaid Services'
      },
      {
        name: 'Mother of Bride/Groom Services',
        description: 'Hair and makeup for mothers of bride and groom',
        quantity: 2,
        unitPrice: 6000,
        category: 'Family Services'
      },
      {
        name: 'On-Site Travel & Setup',
        description: 'Travel to venue and professional setup of mobile salon',
        quantity: 1,
        unitPrice: 8000,
  ...
  'Florist': {
    ...
    items: [
      {
        name: 'Bridal Bouquet',
        description: 'Custom bridal bouquet with premium seasonal flowers',
        quantity: 1,
        unitPrice: 8500,
      ...
      },
      {
        ...
        description: 'Coordinating bridesmaid bouquets',
        quantity: 4,
        unitPrice: 3500,
      ...
      {
        name: 'Boutonnieres',
        description: 'Boutonnieres for groom, groomsmen, and fathers',
        quantity: 6,
        unitPrice: 800,
      ...
      },
      {
        ...
        description: 'Large floral arrangements for ceremony altar and aisle',
        quantity: 4,
        unitPrice: 5500,
      ...
      },
      {
        ...
        description: 'Custom table centerpieces for reception tables',
        quantity: 12,
        unitPrice: 2800,
      ...
      },
      {
        ...
        description: 'Setup and arrangement of all floral decorations',
        quantity: 1,
        unitPrice: 12000,
    ...
    items: [
      {
        ...
        description: 'Comprehensive wedding service tailored to your needs',
        quantity: 1,
        unitPrice: 35000,
        category: 'Wedding Services'
      },
      {
        name: 'Setup and Coordination',
        description: 'Professional setup and day-of coordination',
        quantity: 1,
        unitPrice: 15000,
      ...
      },
      {
        ...
        description: 'Miscellaneous services and special requests',
        quantity: 1,
        unitPrice: 10000,
        category: 'Additional Services'
      }
...
Thank you for your interest in our ${serviceType.toLowerCase()} services for your wedding on ${new Date(booking.eventDate).toLocaleDateString()}.

Please find below our detailed quotation for your special day. We've carefully crafted this package to meet your specific requirements and ensure your wedding celebration is absolutely perfect.

We look forward to being part of your magical day!
...
${booking.vendorName}`);
  ...
  const addCustomItem = () => {
    const newItem: QuoteItem = {
      id: `custom-${Date.now()}`,
      name: 'Custom Service',
      description: 'Additional service as requested',
      quantity: 1,
      unitPrice: 0,
      total: 0,
      category: 'Additional Services'
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-rose-50 to-pink-50 px-8 py-6 border-b border-rose-100">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Create Wedding Quote</h2>
        ...
        <div className="flex h-[calc(90vh-120px)]">
            ...
            <div className="space-y-6">
              ...
              {Object.entries(groupedItems).map(([category, items]) => (
                <div key={category} className="space-y-4">
                  <h4 className="font-semibold text-gray-800 text-lg border-b border-gray-200 pb-2">
                    {category}
                  </h4>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <input
                              ...
                              className="font-semibold text-gray-900 bg-transparent border-none outline-none text-lg w-full"
          ...
          <div className="w-96 bg-gray-50 p-8 overflow-y-auto border-l border-gray-200">
            <div className="space-y-6">
              {/* Pricing Summary */}
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-rose-500 to-pink-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-rose-600 hover:to-pink-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                >
