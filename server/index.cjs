...
app.post('/api/bookings/request', async (req, res) => {
  try {
    ...
    // Basic booking data that works with current schema
    await sql`
    ...
    const enhancedFields = {
      contact_email: properBookingData.contact_email,
    ...
    const createdBooking = {
      ...
      contact_email: properBookingData.contact_email, // Available in response even if not in DB yet
